...
单张素材 x 三种摆法(共 3 种壁纸) / 桌面桌宠 / 多 IDE 皮肤 / DeepKing 界面皮肤

    import genshen_skin_cp17 as gs
...
包名 genshen-skin-cp17 / 命令 genshen-cp17 / 运行时目录 ~/.genshen-cp17,
两个套件可同时安装、各自切换。
"""
from .characters.cp17_quartet import (  # noqa: F401
    APP_DIR,
    APP_NAME,
    APP_SLUG,
    DEFAULT_MODE,
